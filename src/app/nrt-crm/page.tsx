      ...
      >
        <div className="relative z-10 transform hover:scale-[1.02] transition-transform duration-700 ease-out">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
           NetRoots CRM offers expert support and advanced features, 
           helping businesses streamline operations and grow cost-effectively.
          </p>
      ...
      <section className="py-16 px-6 md:px-20 flex flex-col md:flex-row items-center gap-10">
        <div className="md:w-1/2 transform hover:-translate-y-1 transition-transform duration-500">
          <h2 className="text-2xl font-semibold text-blue-800 mb-4">
           Benefits of CRM Software by NetRoots Technologies
          </h2>
            <div className="w-full">
            <p className="text-gray-700 leading-relaxed mb-4 max-w-3xl mx-auto text-justify">
                Are you struggling to manage customer relationships and marketing efforts efficiently?
                 If manual processes are slowing you down, NetRoots Technologies offers NetRoots
                  CRM a cloud-based customer relationship management solution designed to streamline operations.
            </p>
            ...
            <li className="flex items-start">
                ...
                Automate and manage customer interactions, sales pipelines, and marketing campaigns.
            </li>
            <li className="flex items-start">
                <svg className="w-5 h-5 text-green-500 mt-1 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 01.083 1.32l-.083.094-8 8a1 1 0 01-1.32.083l-.094-.083-4-4a1 1 0 011.32-1.497l.094.083L8 12.584l7.293-7.291a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                Handle contact management, lead tracking, and customer engagement with ease.
            </li>
            <li className="flex items-start">
                <svg className="w-5 h-5 text-green-500 mt-1 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 01.083 1.32l-.083.094-8 8a1 1 0 01-1.32.083l-.094-.083-4-4a1 1 0 011.32-1.497l.094.083L8 12.584l7.293-7.291a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                Improve productivity with integrated marketing automation and data-driven insights.
            </li>
            <li className="flex items-start">
                <svg className="w-5 h-5 text-green-500 mt-1 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 01.083 1.32l-.083.094-8 8a1 1 0 01-1.32.083l-.094-.083-4-4a1 1 0 011.32-1.497l.094.083L8 12.584l7.293-7.291a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                Ensure seamless access to customer data anytime, anywhere, from any device.
            </li>
            
            </ul>
          <p className="text-gray-700 mt-2 leading-relaxed">
            With NetRoots CRM, customer relationship management becomes
             hassle free, allowing you to focus on growing your business!
          </p>
            </div>
