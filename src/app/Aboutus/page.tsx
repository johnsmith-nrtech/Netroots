...
export default function TimelinePage() {
  ...
  const companyTimeline: TimelineItem[] = [
    ...
    { title: "Opened Research & Development Office in Lahore", text: "In 2016, Netroots opened its offices in Lahore to expand its business. We offer a Multi-Channel Experience and Engagement Marketing Platform, enabling hundreds of leading brands to drive engagement and increase revenue.", image: "/images/llahore.png" },
